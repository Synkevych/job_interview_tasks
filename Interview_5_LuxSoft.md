...
1. **Call** - позволяет вызвать LexicalEnviropment функцию с определенным значением this.
...
### JSON Web Token - исп. для передачи данных для аутентификации в клиент-серверных приложениях
