...
10. Чем отличается WordPress? 
    _ Предоставляет CMS систему управлением сайтом (админка)
    _ Большое количество плагинов, дополнений, шаблонов и расширений
    _ Коментарии и страницы в виде блога, форм обратной связи  
