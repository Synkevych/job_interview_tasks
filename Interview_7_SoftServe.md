...
### Динамические языки программирования (Ruby, Python, PHP, JS)

Высокоуровневыке языки проргаммирования которые позволяют определять тип данных и осуществлять синтаксический анализ и компиляцию "на лету", на этапе выполнения программы.

* Динамическая система типов
* Отсутствует обязательные декларации типов переменных
* Переменные могут быть определены но не явно задекларированы явно перед использованием(использовать переменную тогда когда нужно)
