...
Объектно ориентированое програмирование - методология программирования описывает любую сущность как объект,  
а программа состоит из совокупности объектов, в сами объекты являются екземплярами определенного класса.

### 1.1.2. DRY принципы

Don't Repeat Yourself - минимизация кода - его переиспользование через наследование или рефакторинг 
...
- Конструктор который состоит из описания объекта
