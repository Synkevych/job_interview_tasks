...
Вопрос связан с примитивными типами в JS(6 видов), они не имеют методов, поэтому они неизменяемые,
нет методов которые могли бы их изменить. Их можно только переназначить. 
Автоупаковка(autoboxing) как у объектов так и у примитивных строк есть конструктор String;
Когда вы пытаетесь вызвать свойство или метод для определенных примитивных(кроме undefined, null) типов JS
